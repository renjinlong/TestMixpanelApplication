...
import com.sxfanalysis.android.util.Base64Coder;
import com.sxfanalysis.android.util.HttpService;
import com.sxfanalysis.android.util.MPLog;
import com.sxfanalysis.android.util.RemoteService;
...
//                final JSONObject eventObj = new JSONObject();
                ...
                //封装埋点数据类型
                sendProperties.put("eId", eventDescription.getEventName());
