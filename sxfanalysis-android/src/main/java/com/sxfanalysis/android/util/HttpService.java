...
public class HttpService implements RemoteService {
    ...
    @Override
    public byte[] performRequest(String endpointUrl, JSONObject params, SSLSocketFactory socketFactory) throws ServiceUnavailableException, IOException {
